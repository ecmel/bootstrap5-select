var bootstrap5 = (function (t, e) {
  ...
  return (
    ...
    (b = function () {
      ...
      if (t) {
        const e = t.dataset.label,
          i = t.dataset.value;
        s(this, a, "m", u).call(this, e, i), s(this, a, "m", d).call(this, i);
      } else if (s(this, c, "f")) {
    ...
    (k = function () {
      ...
      t &&
        (s(this, a, "m", m).call(this, t),
        s(this, a, "m", d).call(this, t.dataset.value, !1),
        s(this, a, "m", v).call(this));
    }),
    (E = function (t = !1) {
    ...
    (t.Select = class {
      constructor(t) {
        a.add(this),
          ...
          T.set(this, () => {
            const t = [],
              e = s(this, a, "m", w).call(this, s(this, l, "f").value);
            if (e.length > 0)
              for (const i of s(this, h, "f").options)
                if (!i.selected) {
                  if (s(this, a, "m", w).call(this, i.label).includes(e)) {
